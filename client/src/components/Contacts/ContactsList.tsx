        ...
        <div className="contacts-list">
            ...
            <div>
                <form className="create-contact" action="">
                    ...
                    {!fullFields && <p>Заполните все поля</p>}
                    <input onBlur={() => checkFields()} className="create-contact__input" onChange={(e) => newContactHandler(e)} value={newContact.name} placeholder="Name..." name="name" type="text" />
                    <input onBlur={() => checkFields()} className="create-contact__input" onChange={(e) => newContactHandler(e)} value={newContact.email} placeholder="Email..." name="email" type="email" />
                    <input onBlur={() => checkFields()} className="create-contact__input" onChange={(e) => newContactHandler(e)} value={newContact.phone} name="phone" type="number" />
